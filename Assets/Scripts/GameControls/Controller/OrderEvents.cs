...
public class OrderEvents : MonoBehaviour
{
    ...
    public delegate void AttackOrder(IDamageable target, bool isReaction);
    ...
    public static void Attack(IDamageable target, bool isReaction) => OnAttack?.Invoke(target, isReaction);
