...
public class HUDController : MonoBehaviour
{
    ...
    void DisplaySelectionButtons(ISelectable Selection)
    {
        ...
        {
            SelectHUD.Buttons.Inventory.onClick.AddListener(delegate { CreateUI.Window.Inventory(SelectionEntity.EntityComponents.Inventory); });
        ...
        {
            SelectHUD.Buttons.Equipment.onClick.AddListener(delegate { CreateUI.Window.Equipment(SelectionEntity); });
        ...
        {
            SelectHUD.Buttons.Stats.onClick.AddListener(delegate { CreateUI.Window.Stats(SelectionEntity.EntityComponents.Stats); });
