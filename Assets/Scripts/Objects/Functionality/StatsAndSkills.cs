...
public class StatsAndSkills : MonoBehaviour
{
    ...
    public class Skill : StatSkill, ICloneable
    {
        [JsonProperty]
        public readonly SkillsEnum SkillName;
        [JsonProperty]
        public ItemTypes.SubTypes[] SubTypes { get; private set; }
        [JsonProperty]
        public float SecondaryTypeCoefficient { get; private set; }

        public struct StatImpact
        {
            [JsonProperty]
            public float NegativeModifierMax { get; private set; }
            [JsonProperty]
            public float PositiveModifierMax { get; private set; }
            [JsonProperty]
        ...
        private StatsAndSkills Owner;
        public SkillTypes SkillType;
        public KeyValuePair<string, KeyValuePair<StatsEnum, StatImpact>[]>[] StatImpacts;


        public Skill(SkillTypes skillType, KeyValuePair<string, KeyValuePair<StatsEnum, StatImpact>[]>[] statImpacts, string Description, string[] XPGainActivities, KeyValuePair<string, string>[] AffectedActivities, bool Enabled = true) : base(Description, XPGainActivities, AffectedActivities, Enabled)
        {
            SkillType = skillType;
            StatImpacts = statImpacts;
        }

        public int GetAdjustedLevel(string actionStat)
        {
            float unroundedResult = Level;
            KeyValuePair<StatsEnum, StatImpact>[] impacts;
            impacts = StatImpacts.FirstOrDefault(s => s.Key == actionStat).Value;
            foreach(KeyValuePair<StatsEnum, StatImpact> impact in impacts)
            {
                int statLevel = Owner.Stats[impact.Key].GetAdjustedLevel();
                float modifierPercent = (impact.Value.PositiveModifierMax - impact.Value.NegativeModifierMax) / 100f;
                unroundedResult *= statLevel * modifierPercent + impact.Value.NegativeModifierMax;
            }

            if (impacts.Length == 0) throw new System.ComponentModel.WarningException($"No impacts in '{SkillName}' were found for ActionStat '{actionStat}'");

            return Mathf.Max(Mathf.RoundToInt(unroundedResult), 1);
        }
        ...
        public object Clone(StatsAndSkills owner)
        {
            Owner = owner;
            return MemberwiseClone();
        }
    ...
    public async void Init()
    {
        ...
        foreach (KeyValuePair<SkillsEnum, Skill> kvp in LoadedSkills)
        {
            Skill clone = (Skill)kvp.Value.Clone(this);
    ...
    public Skill[] GetItemSkills(ItemTypes.SubTypes subType)
    {
        Skill[] result = new Skill[2];
        result[0] = Skills.First(s => s.Value.SubTypes != null && s.Value.SubTypes[0] == subType).Value;
        result[1] = Skills.Last(s => s.Value.SubTypes != null && s.Value.SubTypes[0] == subType).Value;
        return result;
    }
    ...
    public static Dictionary<SkillsEnum, Skill> LoadedSkills = new Dictionary<SkillsEnum, Skill>();
    public Dictionary<SkillsEnum, Skill> Skills = new Dictionary<SkillsEnum, Skill>
    {
        //{   SkillsEnum.Swords, new Skill(Skill.SkillTypes.Melee, 
        //    new KeyValuePair<StatsEnum, Skill.StatImpact>[] 
        //    {
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Strength, new Skill.StatImpact(0.75f, 1.25f, 0.25f)),
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Dexterity, new Skill.StatImpact(0.5f, 1.5f, 0.5f))
        //    }, 
        //    "Proficiency with all swords.", new string[]{"Fighting with swords"}, SkillEffects[SkillsEnum.Swords] )},
        //{   SkillsEnum.Polearms,          new Skill(Skill.SkillTypes.Melee,
        //    new KeyValuePair<StatsEnum, Skill.StatImpact>[]
        //    {
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Strength, new Skill.StatImpact(0.75f, 1.25f, 0.25f)),
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Dexterity, new Skill.StatImpact(0.5f, 1.5f, 0.5f))
        //    }, 
        //    "Proficiency with all polearms.", new string[]{"Fighting with polearms"}, SkillEffects[SkillsEnum.Polearms] )},
        //{   SkillsEnum.Quarterstaffs,     new Skill(Skill.SkillTypes.Melee,
        //    new KeyValuePair<StatsEnum, Skill.StatImpact>[]
        //    {
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Strength, new Skill.StatImpact(0.75f, 1.25f, 0.25f)),
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Dexterity, new Skill.StatImpact(0.5f, 1.5f, 0.5f))
        //    }, 
        //    "Proficiency with quarterstaffs.", new string[]{"Fighting with quarterstaffs"}, SkillEffects[SkillsEnum.Quarterstaffs] )},
        //{   SkillsEnum.Daggers,           new Skill(Skill.SkillTypes.Melee,
        //    new KeyValuePair<StatsEnum, Skill.StatImpact>[]
        //    {
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Strength, new Skill.StatImpact(0.75f, 1.25f, 0.25f)),
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Dexterity, new Skill.StatImpact(0.5f, 1.5f, 0.5f))
        //    }, 
        //    "Proficiency with daggers and knives.", new string[]{"Fighting with daggers"}, SkillEffects[SkillsEnum.Daggers] )},
        //{   SkillsEnum.Hammers,           new Skill(Skill.SkillTypes.Melee,
        //    new KeyValuePair<StatsEnum, Skill.StatImpact>[]
        //    {
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Strength, new Skill.StatImpact(0.75f, 1.25f, 0.25f)),
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Dexterity, new Skill.StatImpact(0.5f, 1.5f, 0.5f))
        //    }, 
        //    "Proficiency with Hammers, mauls, and other weapons which function via the 'cause your organs to cease functioning due to trauma' effect.", new string[]{"Fighting with hammers"}, SkillEffects[SkillsEnum.Hammers] )},

        //{   SkillsEnum.Handguns,          new Skill(Skill.SkillTypes.Ranged,
        //    new KeyValuePair<StatsEnum, Skill.StatImpact>[]
        //    {
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Strength, new Skill.StatImpact(0.9f, 1.1f, 0.25f)),
        //        new KeyValuePair<StatsEnum, Skill.StatImpact>(StatsEnum.Dexterity, new Skill.StatImpact(0.5f, 1.5f, 0.5f))
        //    }, 
        //    "Proficiency with all handguns", new string[]{"Fighting with handguns"}, SkillEffects[SkillsEnum.Handguns] )},
